function P = rosa_lineextract(P, meanpag, bUpdateConnectivity)
%
...
if (bUpdateConnectivity)
    %[nodelabel,~] = define_nodeleabel(P.cpts,P.rings);
    %[P.spls, P.corresp] = Farthestsampling_by_sphere(P.cpts,nodelabel,meanpag);
    [P.spls,P.corresp] = farthest_sampling_by_sphere(P.cpts, meanpag);
